...
class AuthServiceClass {
  ...
  async registerOrganization(data: RegisterOrganizationDto): Promise<ApiResponse> {
    try {
      const response = await apiClient.post<ApiResponse>('/api/auth/register/organization', data);
  ...
  async registerIndividual(data: RegisterIndividualDto): Promise<ApiResponse> {
    try {
      const response = await apiClient.post<ApiResponse>('/api/auth/register/individual', data);
