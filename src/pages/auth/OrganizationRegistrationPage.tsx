...
import { OrganizationRegistrationDto, IndustryType } from '../../models';
...
const OrganizationRegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const registrationData: OrganizationRegistrationDto = {
        ...
        admin_name: formData.name.trim(),
        admin_username: formData.username.trim(),
        admin_email: formData.email.trim(),
        admin_password: formData.password,
        confirm_password: formData.confirmPassword,
        terms_accepted: formData.termsAccepted,
        privacy_policy_accepted: true // Set to true since we're handling terms
      };
