...
import GridAccordionTable from '../../../Gridnpm/GridAccordionTable';
    ...
    <OnboardingContainer>
      ...
      <ContentArea>
        ...
        {selectedOption === OnboardingOption.CSV && (
          <>
            <h3 style={{ marginBottom: '1.5rem', color: '#1e293b' }}>Import Students from CSV</h3>
            <p style={{ color: '#64748b', marginBottom: '2rem' }}>
              Upload a CSV file with columns: <strong>name, email, educationLevel</strong>
            </p>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.875rem', color: '#64748b' }}>
                Expected columns: name, email, educationLevel
              </p>
